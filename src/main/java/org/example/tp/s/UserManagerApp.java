...
public class UserManagerApp {
    ...
    public static void main(String[] args) {
        ...
        UserAuthenticator userAuthenticator = new UserAuthenticator(data, userValidator);
        UserRegistration userRegistration = new UserRegistration(data, userValidator);

        User user1 = new User("user1", "admin");
        userRegistration.registerUser(user1);

        User user2 = new User("user2", "Azertyui1235..@@");
        userRegistration.registerUser(user2);
        userAuthenticator.loginUser(user2);
    }
}
